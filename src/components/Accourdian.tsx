...
export const FaqAccordion: React.FC<FaqAccordionProps> = ({ items }) => {
    ...
    return (
        <div className="w-full flex justify-center px-4 py-20 my-16 bg-white">
            <div className="w-4/5 mx-auto px-4 sm:px-6">
                <h1 className="text-start font-extrabold text-3xl">FAQs</h1>
                <Accordion
                    type="single"
                    collapsible
                    value={openItem || ""}
